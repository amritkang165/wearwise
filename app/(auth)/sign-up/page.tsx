  ...
  return (
    <>
      ...
      <p className="mt-1.5 text-[14px] text-ash">
        Start managing your wardrobe.
      </p>

      <form onSubmit={handleSubmit} className="mt-8 space-y-4">
        <div className="space-y-1.5">
          <label htmlFor="name" className="text-[12px] font-medium text-ash">
            Name
          </label>
          <input
            id="name"
      ...
      <p className="mt-6 text-center text-[13px] text-ash">
        ...
        <Link href="/sign-in" className="font-medium text-rose hover:text-crimson">
          Sign in
        </Link>
      </p>
    </>
